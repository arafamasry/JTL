...
/* Smarty version 3.1.39, created on 2021-06-09 21:34:37
  from 'C:\xampp-7\htdocs\jtl\admin\opc\tpl\startmenu.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.39',
  'unifunc' => 'content_60c117cd8c7c35_06610662',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '06e622e36444ef8345b7be49b647fda2c86a6458' => 
    array (
      0 => 'C:\\xampp-7\\htdocs\\jtl\\admin\\opc\\tpl\\startmenu.tpl',
      1 => 1621413684,
      2 => 'file',
    ),
  ),
...
function content_60c117cd8c7c35_06610662 (Smarty_Internal_Template $_smarty_tpl) {
if ($_smarty_tpl->tpl_vars['opc']->value->isEditMode() === false && $_smarty_tpl->tpl_vars['opc']->value->isPreviewMode() === false && \JTL\Shop::isAdmin(true)) {?>
    ...
    <?php $_block_plugin19 = isset($_smarty_tpl->smarty->registered_plugins['block']['inline_script'][0][0]) ? $_smarty_tpl->smarty->registered_plugins['block']['inline_script'][0][0] : null;
if (!is_callable(array($_block_plugin19, 'inlineScript'))) {
throw new SmartyException('block tag \'inline_script\' not callable or registered');
}
$_smarty_tpl->smarty->_cache['_tag_stack'][] = array('inline_script', array());
$_block_repeat=true;
echo $_block_plugin19->inlineScript(array(), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();
echo '<script'; ?>
>
...
echo $_block_plugin19->inlineScript(array(), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
...
">
                ...
                <?php $_block_plugin20 = isset($_smarty_tpl->smarty->registered_plugins['block']['alert'][0][0]) ? $_smarty_tpl->smarty->registered_plugins['block']['alert'][0][0] : null;
...
$_block_repeat=true;
echo $_block_plugin20->render(array('variant'=>'danger'), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
                <?php echo __('opcNotSupportedPage');?>

                <?php $_block_repeat=false;
echo $_block_plugin20->render(array('variant'=>'danger'), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
            </div>
